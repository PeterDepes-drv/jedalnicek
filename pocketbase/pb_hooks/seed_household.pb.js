...
//
// POZNÁMKA: Všetky dáta sú zámerne deklarované vo vnútri callbacku (nie ako
// top-level const v súbore) — PocketBase JSVM spúšťa hooky naprieč viacerými
// VM inštanciami a top-level closures sa medzi nimi nemusia spoľahlivo zdieľať
// (v praxi to spôsobovalo "ReferenceError: ... is not defined").
